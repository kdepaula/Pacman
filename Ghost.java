...
public class Ghost extends JComponent
{
		...
		{
			ImageIcon imageIcon = new ImageIcon("images/" + color + " Ghost Left Alt.png");
		...
		public void setLeft(String color)
		{
			removeAll();
			ImageIcon imageIcon = new ImageIcon("images/" + color +  " Ghost Left.png");
			Image image = imageIcon.getImage(); 
		...
		public void setLeftAlt(String color)
		{
			removeAll();
			ImageIcon imageIcon = new ImageIcon("images/" + color + " Ghost Left Alt.png");
			Image image = imageIcon.getImage(); 
		...
		public void setRightAlt(String color)
		{
			removeAll();
			ImageIcon imageIcon = new ImageIcon("images/" + color + " Ghost Right Alt.png");
			Image image = imageIcon.getImage(); 
			Image newimg = image.getScaledInstance(getDiameter(), getDiameter(),  java.awt.Image.SCALE_SMOOTH);
			imageIcon = new ImageIcon(newimg);
			JLabel imageLabel = new JLabel(imageIcon);
		...
		public void setRight(String color)
		{
			removeAll();
			ImageIcon imageIcon = new ImageIcon("images/" + color + " Ghost Right.png");
			Image image = imageIcon.getImage(); 
			Image newimg = image.getScaledInstance(getDiameter(), getDiameter(),  java.awt.Image.SCALE_SMOOTH);
			imageIcon = new ImageIcon(newimg);
			JLabel imageLabel = new JLabel(imageIcon);
